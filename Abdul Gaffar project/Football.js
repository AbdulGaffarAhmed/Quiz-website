var c = 0;
                function change(x){
                    ...
                    if(c == 1)
                    {
                       ...
                       document.getElementById("b").style.background="rgb(13, 245, 13)";
                ...
                function achange(y){
                    ...
                    if(b == 1)
                    {
                       ...
                       document.getElementById("f").style.background="red";
                        ...
                        document.getElementById("h").style.background="rgb(13, 245, 13)";
                ...
                function bchange(z){
                    ...
                    if(d == 1)
                    {
                       ...
                       document.getElementById("j").style.background="red";
                        ...
                        document.getElementById("l").style.background="rgb(13, 245, 13)";
                ...
                function cchange(m){
                    ...
                    if(e == 1)
                    {
                        document.getElementById("m").style.background="rgb(13, 245, 13";
                ...
                function dchange(n){
                    ...
                    if(f == 1)
                    {
                       ...
                       document.getElementById("r").style.background="red";
                        document.getElementById("s").style.background="rgb(13, 245, 13)";
